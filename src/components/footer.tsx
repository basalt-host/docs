...
export function Footer() {
  ...
  return (
    <footer className="border-fd-border bg-fd-card/50 border-t">
      <div className="mx-auto grid w-full max-w-6xl gap-10 px-6 py-14 sm:grid-cols-3 lg:grid-cols-5">
        <div>
      ...
      <div className="border-fd-border border-t">
        <p className="text-fd-muted-foreground mx-auto w-full max-w-6xl px-6 py-6 text-xs">
