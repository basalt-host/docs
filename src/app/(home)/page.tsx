    ...
    <section className="relative">
      ...
      <div className="relative mx-auto grid w-full max-w-6xl items-center gap-14 px-6 pt-20 pb-24 sm:pt-28 lg:grid-cols-[1.1fr_1fr] lg:gap-12 lg:pt-32 lg:pb-32">
        <div>
          ...
          <div className="text-fd-muted-foreground mt-8 flex flex-wrap items-center gap-x-6 gap-y-3 text-sm">
            <span className="border-fd-border bg-fd-card flex items-center gap-2 rounded-lg border px-3 py-1.5 font-mono">
              <Terminal className="size-4 shrink-0" />
              <code>docker compose up -d</code>
            </span>
            <span>Free tier: 2 users, 2 instances, 1 node.</span>
          </div>
        </div>
...
const faqs: { question: string; answer: ReactNode; text?: string }[] = [
  ...
  },
  {
    ...
    answer:
      "No. The same platform scales from a weekend Minecraft server with friends to a studio running fleets of game servers across many nodes. Role-based access control, per-node isolation and encrypted backups are built in, and the Pay as you go plan adds SSO, audit logging and a support SLA.",
  },
  {
